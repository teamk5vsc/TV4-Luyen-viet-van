...
function buildStudentProfile(student: StudentEntry, submissions: OutlineSubmission[] = [], className: string = ''): StudentProfile {
  ...
  return {
    ...
    badges: [
      { id: 'obs', title: 'Người quan sát tinh tế', description: 'Hoàn thành 1 bài Văn tả cây cối hoặc tả con vật.', emoji: '🌳', unlocked: submissions.some(s => s.type === 'ta-cay-coi' || s.type === 'ta-con-vat') },
      { id: 'nar', title: 'Người kể chuyện', description: 'Hoàn thành 1 bài Kể chuyện đã đọc, đã nghe.', emoji: '🦊', unlocked: submissions.some(s => s.type === 'ke-chuyen-da-doc-da-nghe') },
      { id: 'log', title: 'Nhà lập luận nhỏ tuổi', description: 'Hoàn thành 1 bài Nêu ý kiến.', emoji: '⚖️', unlocked: submissions.some(s => s.type === 'neu-y-kien-hien-tuong' || s.type === 'neu-y-kien-cau-chuyen') },
    ],
    strengthCards: [],
  };
}
...
export default function App() {
  ...
  const [selectionGenreId, setSelectionGenreId] = useState('ta-cay-coi');
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-neutral-500 uppercase tracking-widest mt-1">
                Cổng Học Tập & Dạy Học Tiếng Việt Lớp 4
              </p>
              <p className="text-xs text-neutral-400 max-w-md mx-auto mt-2 leading-relaxed">
                Hệ thống rèn luyện lập bản đồ ý tưởng, viết văn tự động với AI và đo lường sự tiến bộ dành riêng cho lớp 4.
              </p>
            </div>
          </motion.div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="flex items-center space-x-2">
                  <h1 className="text-lg font-heading font-extrabold text-white tracking-tight drop-shadow-sm">VietMaster 4</h1>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 w-full">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-xs font-heading font-bold text-neutral-700 uppercase tracking-wider">VietMaster 4 • Bản Đồ Ý Tưởng Sư Phạm</p>
                  <p className="text-[10px] text-neutral-400 font-medium mt-0.5">
                    Tiếng Việt Lớp 4 • Hỗ trợ bởi Gemini AI
                  </p>
                </div>
              </div>
