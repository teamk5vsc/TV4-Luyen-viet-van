            ...
            {showParentReport && isTeacher ? (
              ...
              >
                ...
                <div className="text-center space-y-1.5 border-b border-dashed border-neutral-200 pb-5">
                  <span className="text-[10px] font-extrabold text-neutral-400 uppercase tracking-widest block">VietMaster 4 • Hồ Sơ Đánh Giá Định Kỳ</span>
                ...
                <div className="space-y-4 text-xs text-neutral-700 leading-relaxed">
                  ...
                  <p>
                    Dựa trên tiến trình quan sát và rèn luyện lập dàn ý Tiếng Việt lớp 4 của bé <strong>{studentProfile.name}</strong>, hệ thống thông minh xin gửi sơ bộ tóm tắt định tính kết quả học tập vượt khó học kỳ vừa rồi:
                  </p>
