          ...
          <div className="relative flex items-start justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500 mt-0.5">Tiếng Việt lớp 4 • Bản thiết kế ý tưởng viết văn</p>
              </div>
            </div>
          ...
          <div className="md:col-span-3 space-y-6">
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-amber-100/30 shadow-sm space-y-4">
              <div className="flex items-center space-x-2 border-b border-neutral-100 pb-3">
                ...
                <h3 className="font-heading font-bold text-sm text-neutral-800 uppercase tracking-wider">Cấu trúc dàn ý chuẩn lớp 4</h3>
